...
public class Jeopardy implements ActionListener {
	...
	public void run() {
	    ...
	    firstButton = createButton("Shooter Games");
		...
		// method
	    secondButton = createButton("RPG games");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(buttonPressed.equals(firstButton)) {
			askQuestion("This game is a battle royale where you drop from a helicopter", "what is warzone",  200);
			firstButton.setText("");
		}
			// Call the askQuestion() method
		if(buttonPressed.equals(secondButton)) {
			askQuestion("this game is a shooter game where you buy guns from the begginning of a round, and push two sites", "what is CSGO", 200);
